...
int canWinNextRound(int player) {
// Vérifie les lignes
for (int i = 0; i < ROWS; i++) {
for (int j = 0; j < COLS - 3; j++) {
if (grille[i][j] == player && grille[i][j + 1] == player && grille[i][j + 2] == 0 && grille[i][j + 3] == 0) {
return j + 2;
}
}
}
...
if (grille[j][i] == player && grille[j + 1][i] == player && grille[j + 2][i] == 0 && grille[j + 3][i] == 0) {
return i;
}
}
}
...
for (int j = 0; j < COLS - 3; j++) {
if (grille[i][j] == player && grille[i + 1][j + 1] == player && grille[i + 2][j + 2] == 0 && grille[i + 3][j + 3] == 0) {
return j + 2;
}
}
}
...
static int demande_nb_joueur(void)
{
   ...
   // scanf("%d", &njoueur) ;
    while (1)
    {
        printf("Combien de joueurs prennent part à cette partie ? [3 pour IA vs IA ] ");
        ...
        else if (njoueur != 1 && njoueur != 2 && njoueur !=3)
...
static int ia2(int jeton){
	srand(time(NULL));
    int nbgen=rand()%6;
	  int canWin = canWinNextRound(jeton);
	
            if (canWin != -1) {
                      return canWin;
                  } else {
                    int canBlock = canWinNextRound(jeton % 2 + 1);
...
int main(void)
{
	...
	printf("\n$$$$$$$$$$$$$$$$$CHOISISSEZ VOTRE PARTIE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n $$$$$$$$$$MODE 1 Joueur VS ia (1-niveau facile, 2-niveau moyen , 3-niveau difficile)$$$$$$$$ \nMODE 2 [joueur1 vs joueur2] \n$$$$$$$$MODE 3  ia vs ia$$$$$$$$$$\n ");
    int statut;
    ...
    while (1)
    {
     ...
     switch(njoueur)
      { //debut njoueur
           case 1:
               printf("Choississez un niveau 1-facile 2-moyen 3-difficile \n");
               scanf("%d",&niveau);
               switch(niveau){//switch niveau debut
				   case 1:
                     while(1){//cas 1 while 
					     if(jeton == J1_JETON){
           ...
           // printf("Joueur 2 : %d\n", coup + 1);
              ...
              break;
              default:
               printf("Champion ce niveau n existe pas encore!!\n");
               continue;
              break;
